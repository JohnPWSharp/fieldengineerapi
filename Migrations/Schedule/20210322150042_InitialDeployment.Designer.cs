...
namespace FieldEngineerApi.Migrations.Schedule
{
    ...
    [Migration("20210322150042_InitialDeployment")]
            ...
            modelBuilder.Entity("FieldEngineerApi.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDateTime = new DateTime(2021, 3, 12, 15, 0, 42, 286, DateTimeKind.Local).AddTicks(1498)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            StartDateTime = new DateTime(2021, 3, 14, 15, 0, 42, 289, DateTimeKind.Local).AddTicks(936)
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            StartDateTime = new DateTime(2021, 3, 15, 15, 0, 42, 289, DateTimeKind.Local).AddTicks(962)
                        },
                        new
                        {
                            Id = 4L,
                            ...
                            ProblemDetails = "Boiler wont start",
                            StartDateTime = new DateTime(2021, 3, 17, 15, 0, 42, 289, DateTimeKind.Local).AddTicks(966)
                        });
                });
