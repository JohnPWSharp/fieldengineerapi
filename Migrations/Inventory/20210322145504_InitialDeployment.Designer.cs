...
namespace FieldEngineerApi.Migrations.Inventory
{
    ...
    [Migration("20210322145504_InitialDeployment")]
            ...
            modelBuilder.Entity("FieldEngineerApi.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoilerPartId = 1L,
                            Delivered = false,
                            OrderedDateTime = new DateTime(2021, 3, 17, 14, 55, 4, 127, DateTimeKind.Local).AddTicks(5924),
                            TotalPrice = 243.0m,
                            quantity = 30L
                        },
                        new
                        {
                            ...
                            BoilerPartId = 3L,
                            Delivered = true,
                            DeliveredDateTime = new DateTime(2021, 3, 18, 14, 55, 4, 130, DateTimeKind.Local).AddTicks(9776),
                            OrderedDateTime = new DateTime(2021, 3, 15, 14, 55, 4, 130, DateTimeKind.Local).AddTicks(9743),
                            TotalPrice = 39.6m,
                            quantity = 20L
                        });
                });
